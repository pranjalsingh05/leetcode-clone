...
import { get, getStatusColor, post } from "../lib/util";
        ...
        <div className="grid grid-cols-3 gap-4 m-6 flex-grow overflow-y-auto">
            ...
            <div className="rounded-md bg-white col-span-2 p-4 flex flex-col gap-4">
                ...
                <textarea
                    ...
                    className=" h-full w-full flex-grow resize-none outline rounded-md outline-slate-400 focus:outline-slate-800 p-4"
